...
pygame.init()
red = (255,0,0)#picking an rgb colour
blue = (51,153,255)#picking blue colour
grey = (192,192,192)#background colour
green = (51,102,0)#snake colour
yellow = (0,255,255)
#size of window
win_width = 600
win_height = 400
window = pygame.display.set_mode((win_width,win_height))#this is for displaying window
time.sleep(5)#after 5 seconds window will sleep or disappear
pygame.display.set_caption("Snake Game")#caption
time.sleep(2)

snake = 10#we want to create 10x10 square that is why we assign snake is equal to 10
snake_speed = 15
